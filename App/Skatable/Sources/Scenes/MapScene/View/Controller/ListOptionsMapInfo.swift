...
//        let cell = tableView.dequeueReusableCell(withIdentifier: OptionMapInfoCell.cellId, for: indexPath) as! OptionMapInfoCell
...
//        let option2 = Option(nameButton: "Adicionar aos favoritos", icon: UIImage(systemName: Strings.Names.Icons.starCircle)!)
//        let option3 = Option(nameButton: "Avaliação do Pico", icon: UIImage(asset: Assets.Images.spotCircle)!)
//        let option4 = Option(nameButton: "Reportar Problema", icon: UIImage(systemName: Strings.Names.Icons.exclamationMark)!)
//        let option5 = Option(nameButton: "Descrição do Stopper", icon: UIImage(systemName: Strings.Names.Icons.xMark)!)
//        let option6 = Option(nameButton: "Reportar Problema", icon: UIImage(systemName: Strings.Names.Icons.exclamationMark)!)
//
